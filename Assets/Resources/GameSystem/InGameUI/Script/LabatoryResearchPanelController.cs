...
public class LabatoryResearchPanelController : MonoBehaviour
{
    ...
    public void Scaling()
    {
        ...
        TechTreeScrollPanel.transform.GetChild(2).gameObject.GetComponent<RectTransform>().offsetMin = new Vector2(- CallPanelController.CurrentEdgePadding, 0);
        TechTreeScrollPanel.transform.GetChild(2).gameObject.GetComponent<RectTransform>().offsetMax = new Vector2(0, - CallPanelController.CurrentEdgePadding);
